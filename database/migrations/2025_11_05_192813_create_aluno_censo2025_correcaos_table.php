...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('aluno_censo_2025_correcao', function (Blueprint $table) {
            ...
            $table->string('tipo_veiculo_transporte_escolar', 50)->nullable();
            ...
            $table->string('organizacao_curricular_turma', 100)->nullable();
            $table->string('areas_itinerario_formativo', 100)->nullable();
